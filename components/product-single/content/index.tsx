...
import CheckboxColor from './../../products_filter/form-builder/checkbox-color';
    ...
    <section className="product-content">
      ...
      <div className="product-content__filters">
        <div className="product-filter-item">
          <h5>Color:</h5>
          <div className="checkbox_color_wrapper">
        ...
        <div className="product-filter-item">
          ...
          <div className="quantity-buttons">
            ...
            <button type="submit" onClick={() => addToCart()} className="btn btn__rounded btn__yellow">Add to cart</button>
