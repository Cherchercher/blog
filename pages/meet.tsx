import type {
  ...
  function Page({
    ...
    const { programName, productId, priceId } = router.query;
    ...
    useEffect(() => {
        dispatch({
            ...
            payload: programName, //payload from date respecting timezone
        })
        dispatch({
          type: "SET_PRICE_ID",
          payload: priceId, //payload from date respecting timezone
      })
      dispatch({
        type: "SET_PRODUCT_ID",
        payload: productId, //payload from date respecting timezone
    })
